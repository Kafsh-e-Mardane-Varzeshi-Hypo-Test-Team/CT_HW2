...
type ListPublishedProblemsParams struct {
	Limit  int32 `db:"limit" json:"limit"`
	Offset int32 `db:"offset" json:"offset"`
}

func (q *Queries) ListPublishedProblems(ctx context.Context, arg ListPublishedProblemsParams) ([]Problem, error) {
	rows, err := q.db.Query(ctx, listPublishedProblems, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
